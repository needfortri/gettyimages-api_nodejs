...
class Credentials {
    constructor(apiKey, apiSecret, username, password, refreshToken, hostName, forceAccessToken) {
        this.apiKey = apiKey;
        ...
        this.forceAccessToken = forceAccessToken;
    }
    ...
    get forceAccessToken() {
        return _accessToken.get(this);
    }
    set forceAccessToken(value) {
        _accessToken.set(this,value);
    }
    ...
    async getAccessToken() {
        ...
        if (this.forceAccessToken && this.forceAccessToken.length > 0) {
            return {
                access_token: this.forceAccessToken
            }
        }
